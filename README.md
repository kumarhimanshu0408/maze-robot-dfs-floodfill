...
**Repository Name:** `maze-robot-dfs-floodfill`  
**Description:** Autonomous maze exploration and shortest-path navigation using DFS-based mapping, flood-fill planning, and continuous robot kinematics in MATLAB. Includes a maze creator GUI.
